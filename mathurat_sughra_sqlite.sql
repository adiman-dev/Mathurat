...
--recitation_time: 1:pagi, 2:petang, 3:any
...
INSERT INTO "mathurat_sughra" VALUES(8, 7, 2, 1, "صِرَٰطَٱلَّذِينَ أَنۡعَمۡتَعَلَيۡهِمۡ غَيۡرِ ٱلۡمَغۡضُوبِعَلَيۡهِمۡوَلَا ٱلضَّآلِّينَ ٧", "", 3);
INSERT INTO "mathurat_sughra" VALUES(9, 1, 3, 1, "الٓمٓ ١", "Al Baqarah (1-5)", 3);
INSERT INTO "mathurat_sughra" VALUES(10, 2, 3, 1, "ذَٰلِكَٱلۡكِتَٰبُ لَا رَيۡبَۛ فِيهِۛ هُدٗى لِّلۡمُتَّقِينَ ٢", "", 3);
...
INSERT INTO "mathurat_sughra" VALUES(12, 4, 3, 1, "وَٱلَّذِينَ يُؤۡمِنُونَ بِمَآ أُنزِلَ إِلَيۡكَ وَمَآ أُنزِلَ مِن قَبۡلِكَ وَبِٱلۡأٓخِرَةِ هُمۡيُوقِنُونَ ٤", "", 3);
...
INSERT INTO "mathurat_sughra" VALUES(61, 2, 29, 1, "تُولِجُ اللَّيْلَ فِي النَّهَارِ وَتُولِجُ النَّهَارَ فِي اللَّيْلِ وَتُخْرِجُ الْحَيَّ مِنْ الْمَيِّتِ وَتُخْرِجُ الْمَيِّتَ مِنْ الْحَيِّ وَتَرْزُقُ مَنْ تَشَاءُ بِغَيْرِ حِسَابٍ", "Al Imran (27)", 3);
INSERT INTO "mathurat_sughra" VALUES(62, 1, 30, 1, "اَللَّهُمَّ إِنَّا نَسْأَلُكَ لِسَانًا رَطِبًا بِذِكْرِكَ
وَقَلْبًا مُفْعَمًا بِشُكْرِكَ
...
وَلَا تَكْلِنَا إِلَى أَنْفُسِنَا طَرْفَةَ عَيْنٍ
